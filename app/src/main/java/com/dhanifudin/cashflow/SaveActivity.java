...
public class SaveActivity extends AppCompatActivity {
    ...
    public void handleSubmit(View view) {
        ...
        String cek =String.valueOf(amount);
        if (description.isEmpty() && cek.isEmpty()) {
            Toast.makeText(this, "Input Masih Kosong", Toast.LENGTH_LONG).show();
        } else if (description.isEmpty()) {
            descriptionInput.setError("Tolong Diisi");
        } else if (cek.isEmpty()) {
            amountInput.setError("Tolong Diisi");
